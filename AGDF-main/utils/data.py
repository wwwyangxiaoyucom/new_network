...
class MergedDataset(Data.Dataset):
    def __init__(self, mdfa_base_dir='/home/yangyufang/AGPCNet-main/data/MDFA', sirstaug_base_dir='/home/yangyufang/AGPCNet-main/data/sirst_aug', mode='train', base_size=256):
...
class MDFADataset(Data.Dataset):
    def __init__(self, base_dir='/home/yangyufang/AGPCNet-main/data/MDFA', mode='train', base_size=256):
        assert mode in ['train', 'test']
...
class SirstAugDataset(Data.Dataset):
    def __init__(self, base_dir='/home/yangyufang/AGPCNet-main/data/sirst_aug', mode='train'):
        assert mode in ['train', 'test']
